...
def test_generate_response_valid_input():
    ...
    # todo: In a more complete test,assert that the mocked model
    ...
    # todo: assert that the response is not empty or is a mocked model output
    # assert response == "Mocked bot response" # If configured the mock decode return value
